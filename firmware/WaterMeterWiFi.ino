...
const int COLD_PIN = D2;  // Pin for cold water meter input
const int HOT_PIN = D1;   // Pin for hot water meter input
...
//*-- Log in settings to  http://open-monitoring.online
String ID = "****"; // YOUR ID                          
String KEY = "*****"; // YOUR KEY                             
long interval = 120000; // Timeout interval (120 sec)
...
// This section is needed for WiFi update firmware
...
// End section for WiFi update firmware  
...
//This site available on 192.168.1.125:8080 (your IP address arduino)
